...
using S3Object = EvetWebsite.Services.AwsDtos.S3Object;
...
namespace EvetWebsite.Services.AWS
{
    public class StorageService : IStorageService
    {
        ...
        public async Task<FileReturnResponseDto> UploadFileReturnUrlAsync(AwsDtos.S3Object obj, AwsCredentials awsCredentialsValues, string old_key)
        {
            var credentials = new BasicAWSCredentials(awsCredentialsValues.AccessKey, awsCredentialsValues.SecretKey);
        ...
        public async Task<FileReturnResponseDto> MainUploadFileReturnUrlAsync(string old_key, IFormFile? file)
        {
            ...
            if (file != null)
            {
                ...
                var s3Obj = new AwsDtos.S3Object()
                {
